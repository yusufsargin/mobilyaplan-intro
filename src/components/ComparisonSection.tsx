            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-zinc-200/80 text-zinc-700 border border-zinc-300 uppercase">
                    {item.badge}
                  </span>
                </div>
              ...
              <div className="pt-4 mt-4 border-t border-zinc-200 flex items-center gap-1.5 text-[11px] font-mono text-zinc-500 group-hover:text-zinc-800 transition-colors">
        ...
        <div className="bg-white border border-zinc-200 rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 bg-zinc-100 border-b border-zinc-200 text-xs font-mono font-bold text-zinc-800">
            ...
            <div className="md:col-span-5 p-4 sm:p-5 flex items-center justify-between border-t md:border-t-0 md:border-l border-zinc-200 bg-zinc-200/50 text-zinc-900">
              ...
              <span className="text-[10px] font-mono bg-zinc-900 text-white px-2 py-0.5 rounded font-black tracking-widest">
                {comp.brandTag}
              </span>
            </div>
          </div>
            ...
            {comp.rows.map((row, idx) => (
              ...
              >
                ...
                <div className="md:col-span-3 p-4 sm:p-5 flex flex-col justify-center">
                  ...
                  <span className="text-[11px] text-zinc-500 font-mono mt-0.5">{row.advantage}</span>
                </div>
                ...
                <div className="md:col-span-4 p-4 sm:p-5 md:border-l border-zinc-200 flex items-start gap-3 bg-zinc-50/50">
                  <div className="w-5 h-5 rounded-full bg-red-100 text-red-600 flex items-center justify-center shrink-0 mt-0.5 text-[10px]">
                ...
                <div className="md:col-span-5 p-4 sm:p-5 md:border-l border-zinc-200 bg-emerald-50/30 flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-emerald-600 text-white flex items-center justify-center shrink-0 mt-0.5 text-[10px] shadow-xs">
